...
const priceTypeMap = {
  peak: {
    solidStyle: "bg-orange-400 hover:bg-orange-400/90",
    dotColor: "bg-orange-600",
    outlineStyle: "border-orange-400 hover:bg-orange-400 hover:text-white",
  },
  "non-peak": {
    solidStyle: "bg-green-600 hover:bg-green-600/90",
    dotColor: "bg-green-500",
    outlineStyle: "border-green-600 hover:bg-green-600 hover:text-white",
  },
};
